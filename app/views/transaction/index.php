       ...
       <div class="col-lg-9 col-12 mb-lg-0 mb-4">
         <div class="card invoice-preview-card">
           <div class="card-body">
             ...
             <hr class="mx-n4" />
             <form class="source-item py-sm-3" action="YOUR_SERVER_ENDPOINT" method="POST">
               <div id="service-fee">
                 <p>biyaya</p> <?php $looping = $data['loopingCount']; ?> <?php for ($i = 0; $i < $looping; $i++): ?> <div class="mb-3" data-repeater-list="group-a">
     ...
     <script>
       ...
       for (let i = 0; i < 10; i++) {
         ...
         function updatePrice() {
           ...
           fetch("http://final1.test/transaction/getDrugPriceById/" + selectedDrugId).then(response => response.json()).then(data => {
