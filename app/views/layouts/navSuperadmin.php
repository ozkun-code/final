      ...
      <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
        ...
        <div class="app-brand demo ">
          <a href="#" class="app-brand-link">
            ...
            <span class="app-brand-text demo menu-text fw-bold ms-2">SEECARE</span>
          </a>
        ...
        <ul class="menu-inner py-1">
            ...
            <ul class="menu-sub">
              <li class="menu-item">
                <a href="<?= BASEURL; ?>/admin" class="menu-link">
                  <div data-i18n="Without menu">List Of Admins</div>
                </a>
              </li>
              <li class="menu-item">
                <a href="<?= BASEURL; ?>/admin/create" class="menu-link">
                  <div data-i18n="Without navbar">Add New Admins</div>
                </a>
              </li>
            </ul>
          </li>
          ...
          <!-- Appointments -->
          <li class="menu-item">
            <a href="<?= BASEURL; ?>/appointments" class="menu-link">
