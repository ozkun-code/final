<html lang="en" class="light-style layout-menu-fixed layout-compact" dir="ltr" data-theme="theme-default" data-assets-path="http://final1.test/assets/" data-template="vertical-menu-template-free">
...
<head>
  ...
  <link rel="stylesheet" href="http://final1.test/assets/vendor/fonts/boxicons.css" />

  <!-- Core CSS -->
  <link rel="stylesheet" href="<?= BASEURL; ?>/assets/vendor/fonts/boxicons.css" class="template-customizer-core-css" />
  <link rel="stylesheet" href="<?= BASEURL; ?>/assets/vendor/css/core.css" class="template-customizer-theme-css" />
...
<link rel="stylesheet" href="https://demos.themeselection.com/sneat-bootstrap-html-admin-template/assets/vendor/css/pages/app-invoice.css" />

<!-- Page CSS -->

<!-- Helpers -->
<script src="http://final1.test/assets/vendor/js/helpers.js"></script>
<!--! Template customizer & Theme config files MUST be included after core stylesheets and helpers.js in the <head> section -->
<!--? Config:  Mandatory theme config file contain global vars & default theme options, Set your preferred theme option in this file.  -->
<script src="http://final1.test/assets/js/config.js"></script>
</head>
